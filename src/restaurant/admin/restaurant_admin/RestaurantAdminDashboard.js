...
import { useStyles } from "./RestaurantAdminDashboardCss";
    ...
    return(<div className={classes.root}>
      ...
      <AppBar position="static" style={{background:"#fff"}}>
        ...
        <List>
            ...
            <ListItem>
                <ListItemButton onClick={()=>navigate("/restaurantdashboard/displayallcategory")}>
                <ListItemIcon>
            ...
            <ListItem>
                <ListItemButton onClick={()=>navigate("/restaurantdashboard/displayallsubcategory")}>
                <ListItemIcon>
            ...
            <ListItem>
                <ListItemButton onClick={()=>navigate("/restaurantdashboard/displayallfood")}>
                <ListItemIcon>
            ...
            <ListItem>
                <ListItemButton onClick={()=>navigate("/restaurantdashboard/timinginterface")}>
                <ListItemIcon>
             ...
             <ListItem>
                <ListItemButton onClick={()=>navigate("/restaurantdashboard/insertpicture")}>
                <ListItemIcon>
